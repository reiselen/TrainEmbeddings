...
# Extremely simple example script for loading GloVe models
import gensim
import numpy as np
import sys

if (len(sys.argv) < 3):
    print('Usage: python GloVe_example.py <MODELFILE> <Sentence>')
    print('\t<MODELFILE>: Path to the GloVe model file to load.')
